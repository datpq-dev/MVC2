...
public class RemoveItemServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            //1. Customer goes to take Cart
            HttpSession session = request.getSession(false);// client da duoc nam tai phia SV   
            if (session != null) {
            ...
            //5. refresh -> call the View Cart features again using urlReWriting
